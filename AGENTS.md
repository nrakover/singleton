...
- The default MCP tool surface must stay compact:
  `get_capabilities`, `get_inbox`, `ensure_workspace`, `create_session`,
  `send_message`, `read_events`, `list_sessions`, `get_session`,
  `resolve_request`, `cancel_turn`, `close_resource`.
